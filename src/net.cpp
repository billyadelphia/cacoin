...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"167.99.12.133", "167.99.12.133"},
    {"104.248.175.156", "104.248.175.156"},
    {"159.89.124.149", "159.89.124.149"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cacoin is probably already running."), addrBind.ToString().c_str());
        else
